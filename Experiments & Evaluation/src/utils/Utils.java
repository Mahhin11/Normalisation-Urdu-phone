...
public class Utils {
	...
	public static double getSimilarity(String word1, String word2) {
	    ...
	    int lcsValue = LCS(word1, word2);
	    int levenshteinValue = computeLevenshteinDistance(word1, word2);
	    if (Math.min(word1.length(), word2.length()) + levenshteinValue != 0) {
	        EDDist = ((double) lcsValue) / (Math.min(word1.length(), word2.length()) + levenshteinValue);
	    }

	    ArrayList<Integer> prevUrduPhone1 = new ArrayList<>();
	    ArrayList<Integer> prevUrduPhone2 = new ArrayList<>();
	    ArrayList<Integer> nextUrduPhone1 = new ArrayList<>();
	    ArrayList<Integer> nextUrduPhone2 = new ArrayList<>();
	    ArrayList<Integer> prevWord1 = new ArrayList<>();
	    ArrayList<Integer> prevWord2 = new ArrayList<>();
	    ArrayList<Integer> nextWord1 = new ArrayList<>();
	    ArrayList<Integer> nextWord2 = new ArrayList<>();
	    ...
	    try {
	        ...
	        prevUrduPhoneDist = getRankCorr(prevUrduPhone1, prevUrduPhone2);
	        nextUrduPhoneDist = getRankCorr(nextUrduPhone1, nextUrduPhone2);
	        prevWordDist = getRankCorr(prevWord1, prevWord2);
	        nextWordDist = getRankCorr(nextWord1, nextWord2);
